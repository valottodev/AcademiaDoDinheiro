...
<main class="blog">
  <section>
    <div class="container">
      ...
      <div class="row d-flex justify-content-between blog-nav">
        <div class="col-md-6 d-flex">
          <div class="col-md-4 btn btn-primary">
            <a class="text-nav-blog" href="#">Dicas para investir</a>
          </div>

          <div class="col-md-4 btn btn-primary">
            <a class="text-nav-blog" href="#">Renda fixa</a>
          </div>

          <div class="col-md-4 btn btn-primary">
            <a class="text-nav-blog" href="#">Renda variável</a>
          </div>
        </div>

        <div class="col-md-5 clinic-tag d-flex align-items-center justify-content-center">
          <a href="clinica.php" class="btn btn-secondary">
            <p>/// Tome as melhores decisões com a clínica financeira</p>
          </a>
        </div>
      </div>
      ...
      <div class="mais">
        <span class="btn btn-primary text-nav-blog">Mais Posts</span>
      </div>
